...
export default {
    getAllFestivals: function(data){
        ...
        axios.get("https://foodtrucker.com.au/wp-json/ft/v1/events?distance="+5 +"&lat="+lat+"&lng="+lng)
        .then(res => console.log(res));

         return axios.get("https://foodtrucker.com.au/wp-json/ft/v1/events?distance="+5 +"&lat="+lat+"&lng="+lng)
